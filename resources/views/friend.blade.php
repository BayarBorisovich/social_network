                ...
                <div class="profile-header">
                    ...
                    <div class="profile-header-content">
                        ...
                        <div class="profile-header-info">
                            <h4 class="m-t-sm">{{ $user->name . ' ' . $user->surname . ' ' . $user->patronymic}}</h4>
                            <p class="m-b-sm">{{ $user->about_of_me }}</p>
                            <a href="{{ route('main') }}" class="btn btn-xs btn-primary mb-2">Edit Profile</a>
                        </div>
                    </div>

                    <ul class="profile-header-tab nav nav-tabs">
                        <li class="nav-item"><a href="{{ route('post') }}" class="nav-link" data-toggle="tab">POSTS</a></li>
                        <li class="nav-item"><a href="#profile-about" class="nav-link" data-toggle="tab">ABOUT</a></li>
                        <li class="nav-item"><a href="#profile-photos" class="nav-link" data-toggle="tab">PHOTOS</a></li>
                        <li class="nav-item"><a href="#profile-videos" class="nav-link" data-toggle="tab">VIDEOS</a></li>
                        <li class="nav-item"><a href="{{ route('friend') }}" class="nav-link active show"
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <div class="friend-info">
                                                    <h4>{{ $friend->name . ' ' . $friend->surname . ' ' . $friend->patronymic }}</h4>
                                                    <p>392 friends {{ $friend->id }}</p>
                                                </div>
                                            </a>
                                        </li>
                                        @endforeach
                        ...
                        <div class="col-md-4 hidden-xs hidden-sm">
                            <ul class="profile-info-list">
                                ...
                                <li>
                                    ...
                                    <div class="value">{{ $user->date_of_birth }}</div>
                                </li>
                                <li>
